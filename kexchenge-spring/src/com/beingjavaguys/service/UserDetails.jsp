    ...
    <div class="add_p_p">
        ...
        <div class="sp_container">
            ...
            <form action="#" method="post" id="loginForm" >
                ...
                <div class="sp_text">
                    <input type="text" id="login_username" title="Enter email/mobile no" placeholder="E-mail / Mobile No" class="sp_text1" />
                </div>
                <div class="sp_text">
                    <input type="password" id="login_password" title="Enter password"  placeholder="Password" class="sp_text1" />
                </div>
                <div class="sp_text">
                ...
                <div class="sp_text">
                    <input type="button" id="submit-link" value="LOGIN" class="sp_button" />
                </div>
            </form>
...
<div class="mid_right">
    <div class="mid_row">
        <div class="mid_row_left">
            <div class="prop">
                <div class="title">
                    <span>Properties</span><label>(700)</label>
                </div>
                <div class="desc">
                    <span>Mumbai</span><label>(300)</label><div class="clear">&nbsp;</div>
                    <span>Thane</span><label>(200)</label><div class="clear">&nbsp;</div>
                    <span>Nasik</span><label>(100)</label><div class="clear">&nbsp;</div>
                    <span>Pune</span><label>(100)</label>
        ...
        <div class="title_slide">
            <img src="assets/images/title.png" width="100%" height="200"></img>
        </div>
    </div><!-- mid row close -->
    <div class="mid_row">
